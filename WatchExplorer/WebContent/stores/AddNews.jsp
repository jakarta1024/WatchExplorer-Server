...
<%
	...
	if (admin == null) {
		request.getRequestDispatcher("/StoreAdminHome.jsp");
	} 
	...
	$(document).ready(function(){
		...
		$("#addNews").validate({
	        ...
	        rules: {
	            validator: {
	                required: true,
	                remote: WS.validateUrl+"?id=AddNewsValidator"
	            }
	        },
	        messages: {
	            validator: "验证码错误"
	...
	<div id="page">
		<div id="register_store_section" class="horizontal_center"
			...
			<section class="full width5">
				<div class="box box-info">输入新闻信息</div>
				<form id="addNews" action="store/admin/addNews" method="POST" enctype="multipart/form-data">
					<p>
					...
					<div class="validator">
						<label class="required" for="validator">验证码:</label><br /> <input
							...
							id="AddNewsValidator" src="randomCode.do?id=AddNewsValidator">
						<a href="javascript: void(0);" onclick="WS.reloadCode('AddNewsValidator');">看不清</a>
					</div>
					</p>
