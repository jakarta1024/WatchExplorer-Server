package com.watchshow.common.pagination;

import com.watchshow.common.util.KeySynchronizer;
...
public class PageUtil {
    ...
    public static Field getPkField(Class<?> cls) {
        ...
        if(pkField == null) {
            LOGGER.error("page error," + cls + " : pk null");
        }
        return pkField;
    }
    ...
    public static <T> String getIdValue(T obj) {
        ...
        try {
            ...
            LOGGER.error("page error," + obj + " : get id value");
        }
        return retVal;
    }
    public static <T> String getIdName(T obj) {
        ...
        try {
            ...
            LOGGER.error("page error," + obj + " : get id name");
        }
        return retVal;
    }
}
